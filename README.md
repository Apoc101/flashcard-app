...
then you can click on the div to change it's bool "flipped" state from false to true and viceversa, hiding content and displaying it depending on its state.
